...
class VAE(nn.Module):
    ...
    def __init__(self, z_dim=32, nc=3, device=torch.device('cuda:0')):
    ...
    def reparameterize(self, mu, logvar):
        ...
        # if mu.is_cuda:
        # stds, epsilon = stds.to(self.device), epsilon.to(self.device)
        # print(epsilon, stds, mu)
...
class AdversarySampler:
    def __init__(self, budget, device=torch.device('cuda:0')):
        self.budget = budget
        self.device = device
    ...
    def sample(self, vae, discriminator, data, cuda):
        ...
        # handle this step in VAALTrainerImagent
        # querry_pool_indices = np.asarray(all_indices)[querry_indices]

        return querry_indices.numpy()